...
<?php
    ...
    $message1 = ''; $nb_error = 0; $type = 'error';
    if(isset($_POST['sendForm'])){
        if ($_POST['name'] == '' || $_POST['mail'] == '' || $_POST['numero'] == '' || $_POST['gender'] == '' || $_POST['Textarea'] == ''){
            $message1 = '<ul class="error">';
            $nb_error++;

            if($_POST['name'] == '')        $message1 .= '<li>Veuillez saisir le nom</li>';
            if($_POST['mail'] == '')        $message1 .= '<li>Veuillez saisir le mail</li>';
            if($_POST['numero'] == '')      $message1 .= '<li>Veuillez saisir le numéro</li>';
            if($_POST['gender'] == '')      $message1 .= '<li>Veuillez saisir le genre</li>';
            if($_POST['Textarea'] == '')    $message1 .= '<li>Veuillez saisir du texte</li>';
            ...
            if ($mailExist){
                $message1 = '<ul class="error">';
                $message1 .= '<li>Email déjà utilisé</li>';
                $message1 .= '</ul>';
                $nb_error++;
            }
...
<?php   } ?>
        ...
        <input type="text" id="name" class="border" name="name" ><span class="error"><?php echo (isset($_POST['name']) && $_POST['name'] == '') ? '*' : ''; ?></span> <br><br>
        
        <label for="mail">E-mail :</label><br>
        <input type="email" id="mail" class="border" name="mail" ><span class="error"><?php echo (isset($_POST['mail']) && $_POST['mail'] == '') ? '*' : ''; ?></span> <br><br> 
        
        <label for="tel">Numéro de téléphone :</label><br>
        <input type="tel" id="tel" class="border" name="numero"
        pattern ="[0-9]{10}"
        maxlength="10"><span class="error"><?php echo (isset($_POST['numero']) && $_POST['numero'] == '') ? '*' : ''; ?></span> <br><br>
        
        <input id="gender" type="radio" name="gender" value="Homme"> Homme 
        <input id="gender" type="radio" name="gender" value="Femme">Femme<span class="error"></span><br><br>
        
        <textarea placeholder="Tapez votre message ici..." name="Textarea" id="message"></textarea><span class="error"><?php echo (isset($_POST['Textarea']) && $_POST['Textarea'] == '') ? '*' : ''; ?></span><br>
